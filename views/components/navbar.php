    ...
    <nav>
        ...
        <ul class="nav">
            ...
            <li class="nav-item dropdown-box">
                ...
                <ul class="dropdown-menu">
                    <li class="dropdown-item">
                        <a href="/list">Raksts</a>
                    </li>
                    <li class="dropdown-item">
                        <a href="/categories">Kategorija</a>
                    </li>
                </ul>
            </li>
        </ul>
